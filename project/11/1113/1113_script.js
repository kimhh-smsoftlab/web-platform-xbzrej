...
class TableView {
    ...
    setDisplay(arData) {
        ...
        this.setItemDisplay(this.__data, arData);
    }
    /* 수정이 필요함  */
    setItemDisplay(originalData, searchData) {
        originalData.forEach(function (orgObj) {
            if (!searchData.includes(orgObj)) {
                this.changeDisplay(orgObj, "none");
            } else {
                this.changeDisplay(orgObj, "flex");
            }
        }, this);
    }

    changeDisplay(obj, value) {
        this.__elem
            .querySelector(`div[data-index="${obj.pq_index}"]`)
...
// var columns = [
//     { id: "id1", field: "name", name: "Attr1", width: 200 },
//     { id: "id2", field: "code", name: "Attr3", width: 200 },
//     { id: "id3", field: "csname", name: "Attr2", width: 200 },
// ];
